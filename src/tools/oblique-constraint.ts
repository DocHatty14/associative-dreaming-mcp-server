...
import {
  generateConstraintReframeScaffold,
  formatScaffoldAsPrompt,
  CreativeScaffold,
} from "../prompts/creative-scaffolds.js";

/**
 * Enhanced Oblique Strategy with application guidance
 */
 ...
 */
const OBLIQUE_STRATEGIES: ObliqueStrategy[] = [
  // Process strategies
  {
    text: "Honor thy error as a hidden intention",
    category: "process",
    applicationPattern:
      "Take your most recent mistake or unexpected result. Treat it as if you meant to do it. What would that intention imply about your direction?",
    whenUseful:
      "When stuck on 'fixing' something that might actually be a feature",
  },
  {
    text: "Use an old idea",
    category: "process",
    applicationPattern:
      "What approach did you abandon earlier? Revisit it with your current knowledge. What do you see differently now?",
    whenUseful:
      "When you've been iterating too long without checking the fundamentals",
  },
  {
    text: "What would your closest friend do?",
    category: "perspective",
    applicationPattern:
      "Think of someone who approaches problems very differently from you. How would they tackle this? What would they prioritize?",
  ...
  },
  {
    ...
    category: "inversion",
    applicationPattern:
      "List 3 things you would never do in this situation. Now consider: what if one of those is actually the answer?",
  ...
  },
  {
    ...
    applicationPattern:
      "What's the weakest part of your current approach? Make it MORE prominent. What does that reveal?",
  ...
  },
  {
    ...
    applicationPattern:
      "Where are you being vague? Force yourself to state exact numbers, names, dates. What changes?",
  ...
  },
  {
    ...
    category: "addition",
    applicationPattern:
      "Where are you being too precise? Zoom out. What's the broader pattern you're trying to achieve?",
  ...
  },
  {
    ...
    category: "meta",
    applicationPattern:
      "Set aside your plans and assumptions. What is actually happening right now? What evidence do you have?",
  ...
  },
  {
    ...
    category: "process",
    applicationPattern:
      "You're debating between two options. What if you did both? What would that look like? What does it reveal about the false dichotomy?",
  ...
  },
  {
    ...
    category: "destruction",
    applicationPattern:
      "Introduce a deliberate inconsistency. Where could you break your own rules productively?",
  ...
  },
  {
    ...
    category: "inversion",
    applicationPattern:
      "Fast-forward to success. Describe what you did. Now work backwards. What was the first step?",
  ...
  },
  {
    ...
    category: "meta",
    applicationPattern:
      "Stop all action. What would naturally happen? Sometimes the best intervention is non-intervention.",
  ...
  },
  {
    ...
    category: "destruction",
    applicationPattern:
      "What constraint are you treating as sacred? Imagine it doesn't exist. What options open up?",
  ...
  },
  {
    ...
    category: "perspective",
    applicationPattern:
      "What would someone who disagrees with you do? Try their approach genuinely, not as a strawman.",
  ...
  },
  {
    ...
    category: "meta",
    applicationPattern:
      "What patterns are you repeating unconsciously? Name them. Now deliberately break one.",
    whenUseful: "When you're on autopilot",
  },
];

/**
 * SCAMPER operations with detailed application
 */
interface ScamperOperation {
  letter: string;
  name: string;
  question: string;
  applicationPattern: string;
...
const SCAMPER_OPERATIONS: ScamperOperation[] = [
  {
    letter: "S",
    name: "Substitute",
    question: "What can you substitute? What can take the place of this?",
    applicationPattern:
      "List the key components. For each one, brainstorm 3 alternatives. Which substitution changes the game?",
  },
  {
    letter: "C",
    name: "Combine",
    ...
    applicationPattern:
      "What two elements, if merged, would create something new? Look for unlikely combinations.",
  },
  {
    letter: "A",
    name: "Adapt",
    ...
    applicationPattern:
      "What successful approach from another field could you borrow? What's the parallel in a different domain?",
  },
  {
    letter: "M",
    name: "Modify/Magnify",
    ...
    applicationPattern:
      "Take one element and make it 10x larger/more intense. What breaks? What becomes possible?",
  },
  {
    letter: "P",
    ...
    applicationPattern:
      "Who would find this valuable that you haven't considered? What problem does this accidentally solve?",
  },
  {
    letter: "E",
    name: "Eliminate",
    ...
    applicationPattern:
      "Remove something you think is essential. Can it work without it? What does its absence reveal?",
  },
  {
    letter: "R",
    ...
    applicationPattern:
      "Flip the order. Start from the end. Do the opposite. What if the effect was the cause?",
  },
];
...
export class ObliqueConstraintTool {
  ...
  public generateConstraint(
    input: ObliqueConstraintInput,
  ): ObliqueConstraintOutput {
    ...
    const selectedConstraint = this.selectConstraint(
      currentBlock,
      constraintType,
    );
    ...
    const scaffoldType =
      constraintType === "creative" ? "random" : constraintType;
    const scaffold = generateConstraintReframeScaffold(
      currentBlock,
      scaffoldType === "random"
        ? this.chooseRandomType()
        : (scaffoldType as "oblique" | "scamper" | "inversion"),
      currentBlock,
    );
    ...
    const applicationHints = this.generateApplicationHints(
      selectedConstraint,
      currentBlock,
    );
  ...
  private selectConstraint(
    ...
    switch (constraintType) {
      ...
      case "scamper": {
        ...
        const operation =
          SCAMPER_OPERATIONS[
            Math.floor(Math.random() * SCAMPER_OPERATIONS.length)
          ];
      ...
      case "creative": {
        ...
        const creativeConstraints =
          this.generateCreativeConstraints(normalized);
        const selected =
          creativeConstraints[
            Math.floor(Math.random() * creativeConstraints.length)
          ];
  ...
  private generateCreativeConstraints(
  ...
  ): Array<{ text: string; application: string }> {
    const constraints = [];
    ...
    constraints.push({
      ...
      application:
        "Artificial urgency reveals priorities. What would you do if you had almost no time?",
    });
    ...
    constraints.push({
      ...
      application:
        "Forced simplification often exposes unnecessary complexity or unclear thinking.",
    });
    ...
    constraints.push({
      ...
      application:
        "Constraints breed creativity. What would you do differently with severe limitations?",
    });
    ...
    constraints.push({
      ...
      application:
        "Sometimes seeing what makes things worse reveals what would make them better.",
    });
    ...
    constraints.push({
      ...
      application:
        "Distance creates objectivity. What advice would you give if it wasn't your problem?",
    });
    ...
    constraints.push({
      ...
      application:
        "Scale changes what matters. What's important at different magnitudes?",
    });
   ...
   */
  private chooseRandomType(): "oblique" | "scamper" | "inversion" | "random" {
    const types: Array<"oblique" | "scamper" | "inversion"> = [
      "oblique",
      "scamper",
      "inversion",
    ];
  ...
  private generateApplicationHints(
    constraint: { constraint: string; application: string },
    block: string,
  ): string[] {
    return [
