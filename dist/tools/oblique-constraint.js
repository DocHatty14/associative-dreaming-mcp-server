...
export class ObliqueConstraintTool {
    ...
    selectContextAwareConstraint(analysis) {
        ...
        const allConstraints = [
            ...this.strategies.map(c => ({ constraint: c, type: 'oblique' })),
            ...this.scamperStrategies.map(c => ({ constraint: c, type: 'scamper' })),
            ...this.creativeConstraints.map(c => ({ constraint: c, type: 'creative' }))
        ];
